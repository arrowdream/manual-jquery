$(function() {
    var menuItem = '<li class="has-submenu"><a href="http://video.php100.com/index.php?tag=jquery&from=manual" target="_blank" class="menu-title"><i class="fa fa-video-camera"></i> <span class="nav-label" style="color:#CCC">jQuery视频大全</span></a></li>';
    menuItem += '<li class="has-submenu"><a href="http://runjs.cn/code/vx7fslko?from=php100" target="_blank" class="menu-title"><i class="fa fa-bug"></i> <span class="nav-label" style="color:#CCC">jQuery代码在线调试</span></a></li>';
    $("#main-menu").append(menuItem);
    function a(a, e) {
        this.$element = $("#col-list"), this.options = r, this.colHeightArray = [], this.styleQueue = [], this._init()
    }
    var e = $("#tips-con"),
        t = e.length >= 1 ? e.data("key") : "tips",
        l = ["cuis"],
        d = window.localStorage ? window.localStorage.getItem(t) : null;
    !d && e.length >= 1 && (e.show(), e.find("#tips-close").click(function() {
    ...
    l.push("ng.cn"), a.prototype = {
        ...
        layout: function(a, e) {
            var t, l, d, u, r, i, s = this.options,
                n = this._getItems(a),
                o = "css",
                v = s.animationOptions,
                c = s.colWidth,
                p = s.gutterWidth,
                h = this.colHeightArray.length,
                y = s.align;
            for (this.$element.append(n), "center" === y ? (t = (this.$element.width() - c * h - p * (h - 1)) / 2, t = t > 0 ? t : 0) : "left" === y ? t = 0 : "right" === y && (t = this.$element.width() - c * h - p * (h - 1)), d = 0, r = n.length; r > d; d++) this._placeItems(n[d], t);
            for (u = 0, i = this.styleQueue.length; i > u; u++) l = this.styleQueue[u], l.$el[o](l.style, v);
        ...
        _placeItems: function(a, e) {
            var t, l, d = $(a),
                ...
                i = u.gutterWidth,
                s = u.gutterHeight,
                n = this.colHeightArray,
                o = (n.length, Math.min.apply({}, n)),
                v = $.inArray(o, n);
            t = v, l = {
                left: (r + i) * t + e,
                top: n[t]
    ...
    i.click(function() {
        var a = $(this);
        a.hasClass("active") ? (a.find(".sub-menu").hide(), a.removeClass("active")) : (s.hide(), i.removeClass("active"), a.find(".sub-menu").show(), a.addClass("active"))
    }), s.find("a").click(function(a) {
        var e = $(this);
        e.data("target");
        s.find("li").removeClass("active"), e.parent().addClass("active")
    ...
    window.location.hostname.indexOf(l.join("")) < 0 && 1, $("#autoquery").autocomplete({
        width: 210,
        lookup: n,
        autoSelectFirst: !0,
        onSelect: function(a) {
