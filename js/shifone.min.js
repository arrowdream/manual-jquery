$(function() {
    ...
    a.click(function() {
        var t = $(this);
        t.hasClass("active") ? (t.find(".sub-menu").slideUp(), t.removeClass("active")) : (e.slideUp(), a.removeClass("active"), t.find(".sub-menu").show(), t.addClass("active"))
    }), t.push("hife"), e.find("a").click(function(a) {
        var t = $(this);
        t.data("target");
        e.find("li").removeClass("active"), t.parent().addClass("active")
    }), $("#left-panel").mCustomScrollbar({
        theme: "rounded"
    });
    var l = window.location.pathname.substring(1);
    var hostArr = l.split("/");
    var hostArrLength = hostArr.length;
    $('li a[href="' + hostArr[hostArrLength-1] + '"]').parent().addClass("active").parent().show().parent().addClass("active");
    var d = $("#tips-con"),
        u = d.length >= 1 ? d.data("key") : "tips",
        r = window.localStorage ? window.localStorage.getItem(u) : null;
    !r && d.length >= 1 && (d.show(), d.find("#tips-close").click(function() {
        d.slideUp(), window.localStorage.setItem(u, "true")
    }), window.setTimeout(function() {
        d.slideUp()
    }, 4e4)), $("#main-wraper").css("min-height", $(window).height() - 46), $("#footer-con").fadeIn(), t.push("ng.cn");
    var v = [{
        value: "all",
        data: "all"
    }, {
